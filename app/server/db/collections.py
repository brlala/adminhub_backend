...
bot_collection = db.get_collection('bot', codec_options=codec_options)
bot_user_collection = db.get_collection('bot_user', codec_options=codec_options)
...
message_collection = db.get_collection('broadcast', codec_options=codec_options)
