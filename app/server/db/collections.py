...
flow_user_collection = db.get_collection('flow', codec_options=codec_options)
portal_user_collection = db.get_collection('portal_user', codec_options=codec_options)
question_user_collection = db.get_collection('question', codec_options=codec_options)
