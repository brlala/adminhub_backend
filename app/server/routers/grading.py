...
from ..db_utils.grading import get_grading_messages_and_count_db, skip_message_db
from ..models.current_user import CurrentUserSchema
from ..models.message import GetMessagesTable, GetGradingsTable, SkipMessage
...
async def get_gradings_message(topic: str = Query(None),
    ...
    messages, total = await get_grading_messages_and_count_db(topic=topic, search_query=search_query,
                                                              ...
                                                              current_page=current_page, page_size=page_size, since=since)
